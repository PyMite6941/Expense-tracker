...
while running:
    ...
    choice = questionary.select(
        ...
        choices=[
            questionary.Seperator('--- Expenses ---'),
            ...
            questionary.Seperator('--- Budgeting ---'),
            questionary.Choice('Create a budget'),
            questionary.Choice('Edit budget'),
            questionary.Seperator('--- Cool Functions ---'),
    ...
    # Add new income
        ...
        for _ in range(amount_of_expenses):
            ...
            if not notes.strip():
                notes = None
            console.print(tracker.add_income(amount,source,currency,date,notes))
    # Edit income
